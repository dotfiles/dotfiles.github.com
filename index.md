...
* [kvendrik's dotfiles](https://github.com/kvendrik/dotfiles) are a collection of aliases and methods that I find most useful for speeding up my front-end web development workflow. They speed up many different processes, from working with Git and Github to converting screen recordings into gifs and managing network processes.
